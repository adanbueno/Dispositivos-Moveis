...
public class PutUserPassword extends Thread {

    EditPasswordUser activity;
    String oldPassword;
    String newPassword;
    ...
    public PutUserPassword(EditPasswordUser activity, String oldPassword, String newPassword, String confirmPassword, String token) {
    ...
    public void run() {
        ...
        try {
            ...
            jsonParam.put("oldPassword", this.oldPassword);
            jsonParam.put("password", this.newPassword);
            jsonParam.put("confirmPassword", this.confirmPassword);
